...
//Configure::write('Config.language', 'deu');
     ...
     */
    Configure::write('Security.salt', 'J72PDpcqTUPmIggl9yUWOIme8IWPsjFciYMiAy46');

    /**
     * A random numeric string (digits only) used to encrypt/decrypt strings.
     */
    Configure::write('Security.cipherSeed', '1504250971311751089116111229071552161976377272221901343448931385');
